...
public class JsonHelper {
    ...
    public static boolean areEqualJSON(String expectedResul,String actualResult) throws JSONException {
        boolean isEqual = true;

        JSONObject jsonExpectedResult=JsonHelper.convertJSON(expectedResul);
